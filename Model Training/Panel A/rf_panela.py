# Model Training for Panel A: Random Forest (RF) with Dragon descriptors
import pandas as pd
import numpy as np
...
# ============================================================
# Random Forest Classification with Correct RepeatedStratifiedKFold
#
# Outer split:
...
print(
    ...
    "no_ecfp, RF, no_SMOTE, correct RepeatedStratifiedKFold"
)
...
for repeat in range(N_REPEATS):
    ...
    for k in range(N_SPLITS):
        ...
        if best_model is not None:
            ...
            # ------------------------------------------------
            # Feature importance for best fold model
            # ------------------------------------------------
...
print(
    ...
    "'all_feature_importances_panela_rf.pkl'."
)


# ------------------------------------------------------------
# 9. Save fold metrics, predictions, repeat metrics,
