...
for repeat in range(5):
    ...
    for k in range(splits):
        ...
        if best_valid_loss < repeat_best_val_loss:
            ...
            repeat_best_hyper = (best_hls, best_alpha, best_lr_init, best_lr)
        ...
        print(f"    Best hyperparameters: hidden_layer_sizes: {best_hls}, alpha: {best_alpha}, learning_rate_init: {best_lr_init}, learning_rate: {best_lr}")
    ...
    print(f"repeat {repeat} Best Model Hyperparameters: hidden_layer_sizes: {repeat_best_hyper[0]}, alpha: {repeat_best_hyper[1]}, learning_rate_init: {repeat_best_hyper[2]}, learning_rate: {repeat_best_hyper[3]}")
