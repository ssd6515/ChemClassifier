# Model Training for Panel C: Gradient Boosting Decision Trees (GBDT) with ECFP molecular fingerprint
import pandas as pd
import numpy as np
...
# ============================================================
# ECFP + GBRT Panel C Classification
...
print(
    ...
    "gbrt_t2_panelc_22048_nosmote, correct RepeatedStratifiedKFold"
)
...
with open("results_gbrt_t2panela_repeat.pkl", "wb") as f:
    pickle.dump(
        {
...
with open("results_gbrt_t2panela_final_metrics.pkl", "wb") as f:
...
# torch.save(best_overall_model, "best_gbdt_model_t2panela.pt")
# print("Best overall GBRT model saved as best_gbdt_model_t2panela.pt")
