# Model Training for Panel C: Logistic Regression with ECFP molecular fingerprint
import pandas as pd
import numpy as np
...
# ============================================================
# ECFP + Logistic Regression ElasticNet Panel C Classification
...
print(
    ...
    "lr_t2_panelc_nosmote, correct RepeatedStratifiedKFold"
)
...
with open("results_lr_t2panela_repeat.pkl", "wb") as f:
    pickle.dump(
        {
...
with open("results_lr_t2panela_final_metrics.pkl", "wb") as f:
...
# torch.save(best_overall_model, "best_lr_model_t2panela.pt")
# print("Best overall LR model saved as best_lr_model_t2panela.pt")
