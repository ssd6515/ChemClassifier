# Model Training for Panel C: Random Forest Classifier with ECFP molecular fingerprint
import pandas as pd
import numpy as np
...
# ============================================================
# ECFP + Random Forest Panel C Classification
...
print(
    ...
    "rdkit+bcf, rf_t2_panelc_noSMOTE, correct RepeatedStratifiedKFold"
)
...
with open("results_rf_t2panela_repeat.pkl", "wb") as f:
    pickle.dump(
        {
...
with open("results_rf_t2panela_final_metrics.pkl", "wb") as f:
...
# torch.save(best_overall_model, "best_rf_model_t2panela.pt")
# print("Best overall RF model saved as best_rf_model_t2panela.pt")
