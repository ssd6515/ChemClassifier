...
# ============================================================
# MACCS + Logistic Regression ElasticNet Panel D
...
print(
    ...
    "lr_t2_paneld_nosmote, correct RepeatedStratifiedKFold"
)
...
# torch.save(best_overall_model, "best_lr_model_t2panelb.pt")
# print("Best overall LR model saved as best_lr_model_t2panelb.pt")
