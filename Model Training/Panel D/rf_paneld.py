# Model Training for Panel D: Random Forest Classifier with MACCS molecular fingerprint
import pandas as pd
import numpy as np
...
# ============================================================
# MACCS + Random Forest Panel D Classification
...
print(
    ...
    "rdkit+bcf, rf_t2_paneld_nosmote, MACCS, correct RepeatedStratifiedKFold"
)
...
with open("results_rf_t2panelb_repeat.pkl", "wb") as f:
    pickle.dump(
        {
...
with open("results_rf_t2panelb_final_metrics.pkl", "wb") as f:
...
# torch.save(best_overall_model, "best_rf_model_t2panelb.pt")
# print("Best overall RF model saved as best_rf_model_t2panelb.pt")
