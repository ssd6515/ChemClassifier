...
print("no_ecfp, LR-ElasticNet, no_SMOTE, C_pool = [0.1, 1.0, 10.0], l1l2_ratio = [0.25, 0.5, 0.75],rdkit")
...
for repeat in range(5):
    ...
    for k in range(splits):
        ...
        # Iterate over each combination of C and l1/l2 ratio
...
torch.save(best_overall_model, 'best_lr_model_panelb.pt')
print("Best overall LR model saved as best_lr_model_panelb.pt")
