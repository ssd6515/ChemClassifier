# Model Training for Panel B: Random Forest (RF) with RDKit descriptors
import pandas as pd
import numpy as np
...
# ============================================================
# Random Forest Panel B Classification
...
print(
    ...
    "no_ecfp, RF_panelb_nosmote, mean_imputation, correct RepeatedStratifiedKFold, "
...
torch.save(
    ...
    "best_rf_model_mean_imp.pt",
)

print("Best overall RF model and imputation means saved as best_rf_model_mean_imp.pt")
...
print("\n============================================================")
print("Applicability Domain Analysis for Selected Best RF Model")
print("============================================================")
...
ad_summary_df.to_csv("rf_panelb_best_model_AD_summary.csv", index=False)

print("\nSaved AD summary to: rf_panelb_best_model_AD_summary.csv")
...
feature_range_df.to_csv("rf_panelb_best_model_training_feature_ranges.csv", index=False)

print("Saved training feature min/max ranges to: rf_panelb_best_model_training_feature_ranges.csv")
...
ad_training_distances_df.to_csv(
    "rf_panelb_best_model_training_AD_distances.csv",
    index=False,
)

print("Saved training AD distances to: rf_panelb_best_model_training_AD_distances.csv")


# ------------------------------------------------------------
# 12. Apply selected best RF model + AD to its held-out test set
# ------------------------------------------------------------

print("\n============================================================")
print("Best RF Model Test Set Predictions with AD Flags")
print("============================================================")
...
best_test_results_df.to_csv(
    "rf_panelb_best_model_test_predictions_with_AD.csv",
    index=False,
)

print("Saved best-model test predictions with AD to: rf_panelb_best_model_test_predictions_with_AD.csv")
...
test_ad_summary_df.to_csv(
    "rf_panelb_best_model_test_AD_summary.csv",
    index=False,
)

print("Saved best-model test AD summary to: rf_panelb_best_model_test_AD_summary.csv")


# ------------------------------------------------------------
# 13. Save final best RF model with AD reference
# ------------------------------------------------------------
...
torch.save(
    ...
    "best_rf_model_mean_imp_with_AD.pt",
)

print("Best overall RF model with AD saved as best_rf_model_mean_imp_with_AD.pt")
...
print(
    ...
    "'all_feature_importances_rf_panelb_mean_imp.pkl'."
)
