...
|   |-- all_feature_importances_rf_panela.pkl
|   `-- all_feature_importances_rf_panelb.pkl
`-- README.md
```
...
Some Gradient Boosting and RF scripts also save feature importance files, for example:
...
The notebook [Feature Importance/FeatureImportance.ipynb](https://github.com/ssd6515/ChemClassifier/blob/e648f50dba96e318822f68b0654564867bb3ba21/Feature%20Importance/FeatureImportance.ipynb) is used to inspect descriptor importance outputs generated by the model training runs.

The repository already contains:

- [Feature Importance/all_feature_importances_rf_panela.pkl](https://github.com/ssd6515/ChemClassifier/blob/e648f50dba96e318822f68b0654564867bb3ba21/Feature%20Importance/all_feature_importances_rf_panela.pkl)
- [Feature Importance/all_feature_importances_rf_panelb.pkl](https://github.com/ssd6515/ChemClassifier/blob/e648f50dba96e318822f68b0654564867bb3ba21/Feature%20Importance/all_feature_importances_rf_panelb.pkl)
...
3. run [RDKit Data Exraction/Generate_RDKit_Features.ipynb](https://github.com/ssd6515/ChemClassifier/blob/e648f50dba96e318822f68b0654564867bb3ba21/RDKit%20Data%20Exraction/Generate_RDKit_Features.ipynb) if you need to regenerate `rdkit_data.csv`
